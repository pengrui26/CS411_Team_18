            ...
            >
              {
                <img
                  alt="Placeholder"
                  src={
                    item.thumbnail_url.includes("404")
                      ? "https://th.bing.com/th/id/OIP.ZyErYmNP0wSWKZ2nPbDTVQHaEx?w=272&h=180&c=7&r=0&o=5&dpr=2&pid=1.7"
                      : processUrl(item.thumbnail_url)
                  }
                  style={{ width: "100%", height: "100%" }}
                />
              }
