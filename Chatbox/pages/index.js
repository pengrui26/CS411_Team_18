  ...
  return (
    <div>
      ...
      <main className={styles.main}>
        ...
        <Link href="/page"style={{backgroundColor:"#02fbf7",color:"white" , marginRight: "5px", padding: "1px 45px",textDecoration:"none"}}>
        Questions
        {/* <p style={{display:"grid",fontSize:"1px",height:"15px"}}>Ask a question to chatGPT</p> */}
        </Link>
        <Link href="/Writing"style={{backgroundColor:"#02fbf7",color:"white",padding: "1px 45px",textDecoration:"none"}}>
         Writing
        </Link>
        </div>
